  ...
  return (
    <div className={styles.each_order_item_container}>
      <div className={styles.order_item_main_info}>
        ...
        <h3 className={styles.order_item_name}>{orderItems[order_item_id].name}</h3>
        <div className={styles.order_item_price}>${orderItems[order_item_id].price}</div>
      </div>
      <div className={styles.order_item_actions_container}>
        ...
        <div className={styles.order_item_edit_buttons}>
          <button
            ...
            onClick={(e) => handleEdit(e, orderItems[order_item_id], (orderItems[order_item_id].quantity - 1))}
          >
            <svg viewBox="0 0 24 24"><path d="M12 22.75c5.937 0 10.75-4.813 10.75-10.75S17.937 1.25 12 1.25 1.25 6.063 1.25 12 6.063 22.75 12 22.75zm0-1.5c-5.11 0-9.25-4.14-9.25-9.25S6.89 2.75 12 2.75s9.25 4.14 9.25 9.25-4.14 9.25-9.25 9.25z"></path><path d="M7.58 12.75h9.266c.414 0 .75-.336.75-.75s-.336-.75-.75-.75H7.58c-.414 0-.75.336-.75.75s.336.75.75.75z"></path></svg>
          </button>
          <button className={styles.order_item_button}
          onClick={(e) => handleEdit(e, orderItems[order_item_id], (orderItems[order_item_id].quantity + 1))}>
