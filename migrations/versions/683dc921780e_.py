...
Revision ID: 683dc921780e
Revises: 
Create Date: 2022-10-26 16:18:22.759773
...
def upgrade():
    ...
    sa.Column('customized_selection_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['customized_selection_id'], ['customized_selections.id'], ondelete='CASCADE'),
